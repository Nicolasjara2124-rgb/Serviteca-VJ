...
// Importamos tu logo real desde la carpeta assets
    ...
    <div className="min-screen w-full bg-slate-950 flex flex-col items-center justify-center p-4 text-slate-200 h-screen select-none font-sans">
      <div className="w-full max-w-sm bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          {/* Mostramos tu logo real perfectamente escalado y con una leve animación de presencia */}
          <img 
            src={miLogo} 
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5 relative">
            ...
            <div className="relative flex items-center bg-slate-950 border border-slate-800 rounded-xl px-3 py-2.5 focus-within:border-blue-500 transition-colors">
              ...
              <input
                ...
                className="bg-transparent text-sm text-white placeholder-slate-600 w-full focus:outline-none tracking-widest"
                autoFocus
              />
              <button
                type="button"
          ...
          <div className="pt-4">
            <button
              type="submit"
              className="w-full py-3 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold rounded-xl shadow-lg shadow-blue-500/10 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
              Ingresar al Sistema
            </button>
          </div>
